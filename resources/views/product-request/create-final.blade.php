    ...
    <section class="create-final">
        ...
        <div class="lg:mx-[30px] mx-[10px] my-[10px] lg:my-[20px]">
            ...
            <div class="flex items-center font-jakarta block lg:hidden justify-between gap-3 ">
                <div>
                    <h1 class="text-primary  font-semibold mb-1 text-sm">Product Request</h1>
                    <h1 class="text-paraColor text-xs ">Request Information</h1>
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 ">
                <div class="col-span-1 lg:col-span-4">
                    ...
                    <div class="bg-white rounded-[20px] p-7">
                        <div>
                            <h1 class="font-jakarta text-noti font-semibold mb-3">Request Information</h1>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                <div class="text-center">
                                    <h1 class="text-primary font-poppins text-sm font-semibold mb-2">Request Code</h1>
                                    <h1 class="text-[#5C5C5C]  font-poppins text-[13px] ">
                                        {{ PrefixCodeID::PO_REQUEST }}-{{ $data['request_code'] }}
                                    </h1>
                                </div>
                                <div class="text-center">
