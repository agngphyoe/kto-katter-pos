    ...
    <section class="Request__Detail">
        ...
        <div class="lg:mx-[30px] mx-[10px] my-[10px] lg:my-[20px]">
            <div class="bg-white rounded-[25px]">
                <div>
                    <br>
                    <h1 class="text-noti  font-jakarta font-semibold text-center mt-5">Request Details</h1>
                    <div class="flex items-center justify-between flex-wrap gap-3 p-5">
                        <x-information title="Transfer Code" subtitle="{{ $productReq->request_inv_code ?? '-' }}" />
                        <x-information title="Remark" subtitle="{{ $productReq->remark ?? '-' }}" />
                        <x-information title="From" subtitle="{{ $productReq->fromLocationName->location_name ?? '-' }}" />
                        <x-information title="To" subtitle="{{ $productReq->toLocationName->location_name ?? '-' }}" />
                        <x-information title="Transfer By" subtitle="{{ $productReq->user->name ?? '-' }}" />
                    </div>
                    <br>
                </div>
            </div>
                                    ...
                                    <tbody class="text-sm font-normal text-paraColor font-poppins">
                                        @forelse($products as $product)
                                            <tr class="bg-white border-b text-left">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    {{ number_format($product->request_qty) }}
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
