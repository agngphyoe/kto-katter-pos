...
@section('mainTitle', 'Customer Import')
...
<section class="import_customer ml-[20px] md:ml-[270px] my-5 mr-[20px]  2xl:ml-[320px]">


    {{-- box start  --}}

    <form id="myForm" action="{{ route('import-customer') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class=" font-jakarta flex items-center justify-center mt-10">
            <div>
                <div class="bg-white animate__animated animate__zoomIn w-full lg:w-[600px]   p-5 shadow-xl rounded-[20px]">
                    ...
                    <h1 class="text-sm text-paraColor font-medium text-center my-5">Documents uploaded here wil be stored
                        in
                        your cloud drive</h1>
                    {{-- drag area start   --}}
