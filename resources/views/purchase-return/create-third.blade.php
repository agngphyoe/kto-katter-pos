                            ...
                            <table class="w-full text-sm  text-gray-500 ">
                                <thead class="  bg-gray-100 font-jakarta text-primary  ">
                                    ...
                                    <tr class="text-left border-b">
                                        ...
                                        <th
                                            class="px-6 animate__animated animate__fadeInTopLeft whitespace-nowrap py-3 text-cneter">
                                            Available Quantity
                                        </th>
                                    </tr>
                                </thead>
                                <tbody class="font-poppins" id="productListContainer">
                                    @include('purchase-return.search-product-list')
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            const storeLocalName = 'purchaseReturnProducts';
            ...
            $('#searchInput').on('input', function() {
                ...
                $.ajax({
                    url: "{{ route('purchase-return-create-third', ['id' => $purchase->id]) }}",
                    method: 'GET',
                    headers: {
