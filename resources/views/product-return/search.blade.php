@forelse($product_returns as $transfer)
    <tr class="bg-white border-b text-left">
        <td scope="row" class=" py-4 whitespace-nowrap px-6">
            {{ $transfer->return_inv_code ?? '' }}
        </td>
        <td scope="row" class=" py-4 whitespace-nowrap px-6">
            {{ $transfer->remark ?? '-' }}
        </td>
        ...
        <td class=" py-4 whitespace-nowrap px-6 text-center">
                    ...
                    <div class="flex items-center  gap-5 icon-container">
                        ...
                        <div class="flex items-center hover-icons ">
                            <div class="flex flex-col gap-6">
                                ...
                                {{-- detail --}}
                                @if (auth()->user()->hasPermissions('product-return-detail'))
                                    <a
                                        href="{{ route('product-return-detail', ['product' => $transfer->return_inv_code]) }}">
                                        <button
