    ...
    <section class="create-final">
        ...
        <div class="lg:mx-[30px] mx-[10px] my-[10px] lg:my-[20px]">
            ...
            <div class="flex items-center font-jakarta block lg:hidden justify-between gap-3 ">
                <div>
                    <h1 class="text-primary  font-semibold mb-1 text-sm">Product Transfer</h1>
                    <h1 class="text-paraColor text-xs ">Transfer Information</h1>
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 ">
                <div class="col-span-1 lg:col-span-4">
                    ...
                    <div class="bg-white rounded-[20px] p-7">
                        <div>
                            <h1 class="font-jakarta text-noti font-semibold mb-3">Transfer Information</h1>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                <div class="text-center">
                                    <h1 class="text-primary font-poppins text-sm font-semibold mb-2">Transfer Code</h1>
                                    <h1 class="text-[#5C5C5C]  font-poppins text-[13px] ">
                                        {{ PrefixCodeID::TRANSFER }}-{{ $data['transfer_code'] }}
                                    </h1>
                                </div>
                                <div class="text-center">
                    ...
                    <div class="bg-white p-7 rounded-[20px] mt-5">
                        <div class="flex items-center justify-between flex-wrap gap-2 ">
                            <h1 class="text-noti font-semibold  mb-2 md:mb-0 font-jakarta">Transfer Products</h1>
                ...
                <div class="col-span-1 hidden font-jakarta lg:block lg:col-span-1">
                    ...
                    <div>
                        <div class="flex justify-between">
                            <div>
                                <h1 class="text-primary font-semibold mb-1 ">Product Transfer</h1>
                                <h1 class="text-paraColor text-sm">Transfer Information</h1>
                            </div>
                            <div class="">
                                <div class="w-12 h-12 flex items-center justify-center mb-3 bg-primary  rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
                        ...
                        <form method="POST" action="{{ route('product-transfer-store') }}" id="transferSubmitForm">
                            @csrf
                            <input type="hidden" name="data" value="{{ json_encode($data) }}">
                            <div>
                                <button id="submitButton"
                                    class="bg-primary rounded-full w-full py-2 text-white font-poppins text-sm mb-5"
                                    type="submit">Confirm Transfer</button>
                    ...
                    <div class="flex flex-col ">
                        ...
                        <a href="{{ route('product-transfer') }}">
                            <button
                                ...
                                type="button">Cancel Transfer</button>
                        </a>
                    </div>
                </form>
            </div>
...
@section('script')
    <script>
        ...
        document.getElementById('transferSubmitForm').addEventListener('submit', function(event) {
