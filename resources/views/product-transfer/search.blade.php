@forelse($product_transfers as $transfer)

    <tr class="bg-white border-b text-left ">
        <td scope="row" class=" py-4 whitespace-nowrap px-6">
            {{ $transfer->transfer_inv_code ?? '' }}
        </td>
        <td scope="row" class=" py-4 whitespace-nowrap px-6">
            {{ $transfer->remark ?? '-' }}
        </td>
        ...
        <td class=" py-4 whitespace-nowrap px-6 w-48">
            {{ dateFormat(Carbon\Carbon::parse($transfer->transfer_date)->format('d-m-Y')) }}
        </td>
                    ...
                    <div class="flex items-center  gap-5 icon-container">
                        ...
                        <div class="flex items-center hover-icons ">
                            <div class="flex flex-col gap-6">
                                ...
                                {{-- detail --}}
                                @if (auth()->user()->hasPermissions('product-transfer-detail'))
                                    <a
                                        href="{{ route('product-transfer-detail', ['product' => $transfer->transfer_inv_code]) }}">
                                        <button
