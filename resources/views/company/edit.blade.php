...
<section class="product-model-create">
    ...
    'title' => 'Edit Company',
    'subTitle' => 'Fill to edit company',
    ])

    {{-- nav end  --}}

    {{-- box start  --}}
    <form id="myForm" action="{{ route('company-update',['company'=>$company->id]) }}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="bg-white mb-5  p-10 shadow-xl rounded-[20px]">
                    <div class="flex md:items-center md:flex-row flex-col  gap-10">
                        <div class="flex flex-col mb-5">
                            <x-input-field-component type="text" value="{{ $company->name }}" label="Company Name" name="name" id="companyName" text="Name..." />
                        </div>

                        <div class="flex flex-col mb-5">
                            <x-input-field-component type="text" value="{{ $company->prefix }}" label="Prefix" name="prefix" id="prefix" text="Prefix..." />
                        </div>
                    </div>
