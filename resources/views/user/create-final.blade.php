...
<section class="user__create">
    ...
    <form id="submitForm" action="{{ route('user-store-final') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="col-span-1 lg:col-span-2">
                    <div class="bg-white px-8 py-4 rounded-[20px] ">
                        <div class="mb-5">
                            ...
                            <h1 class="text-noti font-jakarta text-[18px] text-center font-semibold mb-5">
                                {{ $group->name }}
                            </h1>
                            {{-- view edit start  --}}
                            <div class="grid grid-cols-1 md:grid-cols-2 md:gap-2 mb-6">
                                ...
                                <div class="col-span-1 pb-4 mb-6 xl:mb-0">
                                    <div class="flex items-center justify-between pb-4 border border-b border-x-0 border-t-0 border-primary">
                                        ...
                                        <h1 class="font-jakarta text-sm text-paraColor">
                                            {{ $permission['name'] }}
                                        </h1>
                                        <ul>
                                            <li class="check-box">
                                                <input type="checkbox" style="opacity: 0" class="" id="check{{ $permission['id'] }}" name="permissions[]" value="{{ $permission['id'] }}" {{ in_array($permission['id'], old('permissions', [])) ? 'checked' : '' }} @if ($role->hasPermissions($permission['name'])) checked disabled @endif>
                ...
                <div class="col-span-1 lg:col-span-1">
                    <div class="  rounded-b-[20px] shadow-xl bg-white rounded-[20px]  ">
                        <div class="py-10 px-5 ">
                            <div>
                                {{-- image --}}
                                {{-- <div class="w-28 h-28 relative bg-gray-300 rounded-full mx-auto mb-5" id="addPhoto" style="cursor: pointerc">
                                    <div class="outline outline-1 outline-noti rounded-full w-5 h-5 text-noti flex items-center justify-center text-lg absolute bottom-0 right-3 bg-white">
                                        +</div>
                                    <input type="file" name="image" placeholder="Upload Product Photo" class="outline-dashed w-full outline-1 outline-primary px-4 py-2 rounded-2xl text-sm" id="photoInput" style="display: none;">
                                </div> --}}
                                ...
                                <div class="flex items-center justify-center flex-wrap gap-5 ">
                                    ...
                                    <div class="flex flex-col mb-5  ">
                                        <label for="" class="font-jakarta text-[15px] text-paraColor font-semibold mb-2">User Name
                                        </label>
                                    ...
                                    {{-- phone --}}
                                    <div class="flex flex-col mb-5">
                                        <label for="" class="font-jakarta text-[15px] text-paraColor font-semibold mb-2">Phone
                                            Number</label>
                                    ...
                                    {{--<div class="flex flex-col mb-5">
                                            <label for=""
                                                class="font-jakarta text-[15px] text-paraColor font-semibold mb-2">Company</label>
                                            <input type="text"
                                                class="outline outline-1 text-sm font-jakarta text-paraColor w-[300px]  text-[13px] outline-primary px-8 py-2 rounded-full"
                                ...
                                {{-- <div class="flex flex-col mb-5">
                                            <label for=""
                                                class="font-jakarta text-[15px] text-paraColor font-semibold mb-2">NRC</label>
                                            <input type="text" name="nrc"
                                                class="outline outline-1 text-sm font-jakarta text-paraColor w-[300px]  text-[13px] outline-primary px-8 py-2 rounded-full"
                                                value="{{ $data['nrc'] ?? null }}" readonly>
                            </div> --}}

                            {{-- email --}}
                            {{-- <div class="flex flex-col mb-5">
                                            <label for=""
                                                class="font-jakarta text-[15px] text-paraColor font-semibold mb-2">Email</label>
                                            <input type="text" name="email"
                                                class="outline outline-1 text-sm font-jakarta text-paraColor w-[300px]  text-[13px] outline-primary px-8 py-2 rounded-full"
                                                value="{{ $data['email'] ?? null }}" readonly>
                        </div> --}}
