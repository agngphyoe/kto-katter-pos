@forelse($returns as $return)
    {{-- @php
    $return = \App\Models\PosReturn::find(1);
    dd($return->pointOfSale);
@endphp --}}
    <tr class="bg-white border-b text-left">
        ...
        <td scope="row" class="px-6   py-4 whitespace-nowrap ">
            <h1 class="text-left">
                {{ $return->pointOfSale->order_number }}
            </h1>
        </td>

        <td class="px-6 py-4 whitespace-nowrap text-left">
            {{ $return->pointOfSale->shopper->name }}
        </td>

        {{-- <td class="px-6 py-4 whitespace-nowrap text-center">

            {{ number_format($return->pointOfSale->total_quantity) }}
        </td>

        <td class="px-6 py-4 whitespace-nowrap text-right">

            {{ number_format($return->pointOfSale->total_amount) }}
        </td> --}}

        <td class="px-6 py-4 whitespace-nowrap text-right">

            {{ number_format($return->total_return_amount) }}
        </td>

        <td class="px-6 py-4 whitespace-nowrap text-center">

            {{ number_format($return->total_return_quantity) }}
        </td>
        ...
        <td class="px-6 py-4 whitespace-nowrap">
            ...
            {{ dateFormat($return->return_date) }}
        </td>

        <td class="px-6 py-4 text-noti whitespace-nowrap">
                    ...
                    <div class="flex items-center gap-5 icon-container">
                        ...
                        <div class="flex items-center hover-icons ">
                            <div class="flex flex-col gap-6">
                                ...
                                <a href="{{ route('pos-return-details', ['id' => $return->id]) }}"
