@forelse($product_receives as $transfer)
                    ...
                    <div class="flex items-center  gap-5 icon-container">
                        ...
                        <div class="flex items-center hover-icons ">
                            <div class="flex flex-col gap-6">
                                ...
                                {{-- detail --}}
                                @if (auth()->user()->hasPermissions('product-receive-detail'))
                                    {{-- @if (in_array($transfer->status, ['pending'])) --}}
                                    <a
                                        href="{{ route('product-receive-detail', ['product' => $transfer->transfer_inv_code]) }}">
                                        <button
