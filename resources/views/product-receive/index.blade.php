...
@section('title', 'Product Receive Lists')
@section('mainTitle', 'Product Receive Lists')
...
@section('content')
    <div class=" ">
        ...
        <div class="">
            {{-- search start --}}
            <x-search-com routeName="product-receive-create" exportName="product_receives" name="Create Receive"
                permissionName="product-receive-create" />
            {{-- search end  --}}
            ...
            <div class=" ml-[20px] bg-white px-4 py-3 rounded-[20px]  md:ml-[270px] my-5 mr-[20px] 2xl:ml-[320px]">
                <div class="flex items-center justify-between">
                    ...
                    <h1 class="text-[#999999] font-poppins text-sm">Number of Product Transfers : <span
                            class="text-primary">{{ $product_receives->count() }}</span></h1>
                </div>
                <div>
                    ...
                    {{ $product_receives->links('layouts.paginator') }}
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            var searchRoute = "{{ route('product-receive') }}";
