                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-16 ">
                            ...
                            <div class="font-poppins flex items-center justify-center mt-10">
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <h1 class="text-[13px] text-paraColor ">{{ $payment->paymentableBy?->address ?? '-' }}
                                        </h1>
                                    </div>
                                </div>
                    ...
                    <div class="col-span-1 md:col-span-2 ">
                        <div class="mb-10">
                            ...
                            <div class="flex items-center font-poppins justify-between flex-wrap gap-3 ">
                                <div class="">
                                ...
                                <div class="">
                                    <h1 class="text-primary text-sm font-semibold mb-2">Total Amount</h1>
                                    <h1 class="text-[13px] text-center text-primary">
                                        {{ number_format($purchase->purchase_amount) }} </h1>
                                </div>
                                <div class="">
                                ...
                                <div class="">
                                    ...
                                    <x-badge class="{{ $payment->payment_status =='Complete' ? 'bg-[#00812C]' : 'bg-[#FF8A00]' }} text-white px-3">
                                                    ...
                                                    @forelse($payment->paymentable?->paymentables()->orderByDesc('id')->get() as $payment)
                                                        <tr class="bg-white border-b ">
                                                            <td scope="row" class="px-6 py-3   whitespace-nowrap ">
                                                                {{ number_format($payment->total_paid_amount) }}
