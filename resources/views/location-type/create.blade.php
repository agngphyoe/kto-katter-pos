...
@section('title', 'Location Type Create')
@section('css')
<style>
    .check-box {
        display: flex;
...
<section class="user__create">
    ...
    {{-- main start  --}}
    <form id="myForm" action="{{ route('location-type-store') }}" method="POST">
        @csrf
                            ...
                            <div>
                                <div style="padding:50px;">
                                    ...
                                    <div class="mb-10 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                                        ...
                                        <div class="">
                                            <x-input-field-component type="text" value="" label="" name="location_type_name" id="locationTypeName" text="| Location Type Name" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-1 pb-4 mb-6 xl:mb-0 ">
                                        <div>
                                            <div class="flex items-center justify-between pb-4 border border-b border-x-0 border-t-0 border-primary">
                                                ...
                                                <ul class="">
                                                    <li class="check-box">
                                                        <input type="radio" id="retail" name="sale_type" value="Retail" required>
                                                        <label for="retail">Retail</label><br>
                                                        <input type="radio" id="wholesale" name="sale_type" value="Wholesale " required>
                                                        <label for="wholesale">Wholesale</label><br>
                                                        <input type="radio" id="store" name="sale_type" value="Store" required>
                                                        <label for="store">Store</label>
                                                        <input type="radio" id="none" name="sale_type" value="None" required>
