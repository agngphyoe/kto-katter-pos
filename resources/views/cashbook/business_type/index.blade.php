...
@section('title', 'Business Types List')
@section('mainTitle', 'Business Types List')
...
@section('content')
    ...
    <section class="business__type">
        <div>
            {{-- search start --}}
            <x-search-com routeName="business-type-create" name="Create a Business Type"
                permissionName="business-type-create" />
            {{-- search end  --}}
        ...
        <div class="dat-table font-jakarta md:ml-[270px] my-5 mr-[20px] 2xl:ml-[320px] ml-[20px] ">
            <div class=" bg-white px-4 py-3 rounded-[20px] my-5 ">
                ...
                <div class="flex items-center justify-between">
                    <h1 class="text-[#999999] font-poppins text-sm">Number of Business Type : <span
                            class="showTotal">{{ $total_count }}</span></h1>
                </div>
                    ...
                    <div class=" -z-10 overflow-x-auto shadow-xl  mt-3">
                        <table class="w-full  text-sm text-center text-gray-500 ">
                            ...
                            <tbody id="searchResults"
                                ...
                                @include('cashbook.business_type.search')
                            </tbody>
                        </table>
                    </div>
                    {{ $business_types->links('layouts.paginator') }}
                </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            var searchRoute = "{{ route('business-type-list') }}";
