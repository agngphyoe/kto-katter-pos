...
@section('content')
    ...
    <section class="Expense ">
        ...
        {{-- nav end  --}}
        <form id="createExpenseForm" action="{{ route('expense-store') }}" method="POST">
            @csrf
            {{-- search start --}}
            <div class="data-serch font-poppins text-[15px] mt-10   flex items-center justify-center">
                <div class="bg-white px-10 py-8 rounded-[20px]  ">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        <div>
                            <label for="" class=" block mb-2 text-paraColor font-semibold text-sm">Amount
                        ...
                        <div class="col-span-1 md:col-span-1">
                            <label for="" class=" block mb-2 text-paraColor font-semibold text-sm">Date By
                                <span class="text-red-600">*</span>
                            </label>
                    ...
                    <div class="flex items-center justify-center mt-10 gap-10">
                        <a href="{{ route('expense-list') }}" type="button"
