...
@section('mainTitle', 'Expenses List')
...
@section('content')
    ...
    <section class="master__list ">
        <div>
            {{-- search start --}}
            <x-search-com routeName="expense-create" name="Create Expense" permissionName="expense-create" />
        ...
        <div class="data-table md:ml-[270px] my-5 mr-[20px] 2xl:ml-[320px] ml-[20px] ">
            ...
            <div class="  bg-white px-4 py-3 rounded-[20px] my-5">
                <h1 class="font-poppins text-paraColor font-semibold">
                    ...
                    @endphp
                    Total Expense Amount : <span class="text-red-600">{{ number_format($total_expense) }}</span>
                </h1>
                <div class=" overflow-x-auto shadow-xl mt-3">
                    <table class="w-full text-sm text-center text-gray-500 ">
                        ...
                        <tbody id="searchResults"
                            ...
                            @include('cashbook.expense.search')
                        </tbody>
                    </table>
                </div>
...
@section('script')
    <script>
        $(document).ready(function() {
            var searchRoute = "{{ route('expense-list') }}";
