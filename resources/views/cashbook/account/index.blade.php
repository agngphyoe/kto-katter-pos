...
@section('mainTitle', 'Accounts list')
...
@section('content')
    ...
    <section class="account__type">
        <div>
            {{-- search start --}}
            <x-search-com routeName="account-create" name="Create a Account" permissionName="account-create" />
            {{-- search end  --}}
        ...
        <div class="dat-table font-jakarta md:ml-[270px] my-5 mr-[20px] 2xl:ml-[320px] ml-[20px] ">
            <div class=" bg-white px-4 py-3 rounded-[20px] my-5 ">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <h1 class="text-[#999999] font-poppins text-sm">Number of Account : <span
                            class="text-primary">{{ $accounts->count() }}</span></h1>
                </div>
                    ...
                    <div class=" -z-10 overflow-x-auto shadow-xl  mt-3">
                        <table class="w-full  text-sm text-center text-gray-500 ">
                            ...
                            <tbody id="searchResults"
                                ...
                                @include('cashbook.account.search')
                            </tbody>
                        </table>
                    </div>
                    {{ $accounts->links('layouts.paginator') }}
                </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            var searchRoute = "{{ route('account-list') }}";
